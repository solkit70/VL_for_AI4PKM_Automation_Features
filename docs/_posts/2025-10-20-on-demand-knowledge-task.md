...
![UKTP Workflow Diagram]({{ site.baseurl }}/assets/images/blog/uktp.png)
...
![Web Clipper Trigger]({{ site.baseurl }}/assets/images/blog/web-clipper-trigger.png)

From terminal, we can see that the task is being generated by KTG process.

![KTG Process Terminal]({{ site.baseurl }}/assets/images/blog/ktg-process-terminal.png)
...
![Task Status In Progress]({{ site.baseurl }}/assets/images/blog/task-status-in-progress.png)
...
![Task Completed Output]({{ site.baseurl }}/assets/images/blog/task-completed-output.png)
