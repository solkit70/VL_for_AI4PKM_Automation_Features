...
![UKTP Workflow Diagram]({{ site.baseurl }}/blog/_files_/uktp.png)
...
![Task Status Diagram]({{ site.baseurl }}/blog/_files_/ktm_status_diagram.png)
...
![Web Clipper Trigger]({{ site.baseurl }}/blog/_files_/web-clipper-trigger.png)

From terminal, we can see that the task is being generated by KTG process.

![KTG Process Terminal]({{ site.baseurl }}/blog/_files_/ktg-process-terminal.png)
...
![Task Status In Progress]({{ site.baseurl }}/blog/_files_/task-status-in-progress.png)
...
![Task Completed Output]({{ site.baseurl }}/blog/_files_/task-completed-output.png)
