...
![UKTP Workflow Diagram](_files_/uktp.png)
...
![Task Status Diagram](_files_/ktm_status_diagram.png)
...
![Web Clipper Trigger](_files_/web-clipper-trigger.png)

From terminal, we can see that the task is being generated by KTG process.

![KTG Process Terminal](_files_/ktg-process-terminal.png)
...
![Task Status In Progress](_files_/task-status-in-progress.png)
...
![Task Completed Output](_files_/task-completed-output.png)
